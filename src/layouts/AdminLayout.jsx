...
function SidebarContent({ onNavigate }) {
  ...
  return <>
    <div className="flex h-24 items-center border-b border-white/10 px-6">
      <div>
        <p className="font-display text-2xl text-white">FOOD PACK</p>
    ...
    <div className="mt-auto p-4">
      ...
      <div className="mb-3 rounded-2xl border border-white/10 bg-white/5 p-3">
        <div className="flex items-center gap-3">
          <div className="grid h-10 w-10 place-items-center rounded-full bg-gradient-to-br from-[#d7b65e] to-[#b88b22] font-display text-xs font-bold text-white">FP</div>
          <div className="min-w-0">
            <p className="truncate text-sm font-semibold text-white">FOOD PACK</p>
            <p className="truncate text-[10px] text-white/45">Administration</p>
          </div>
        </div>
      </div>
      ...
      <div className="min-h-screen min-w-0 overflow-x-hidden lg:pl-[272px]">
        <header className="admin-topbar sticky top-0 z-30 flex h-20 items-center justify-between border-b border-[#e2d4b3] bg-white/90 px-4 backdrop-blur-xl sm:px-6 lg:px-8 dark:border-white/10 dark:bg-[#241d0e]/90">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[10px] font-bold uppercase tracking-[.18em] text-[#a67b20]">FOOD PACK</p>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <InstallAppButton compact manifestHref="/admin-manifest.webmanifest" label="Installer FP Admin" />
            ...
            <div className="grid h-11 w-11 place-items-center rounded-2xl bg-gradient-to-br from-[#d7b65e] to-[#B38A2C] font-display text-xs font-bold text-white shadow-md">FP</div>
          </div>
        </header>
